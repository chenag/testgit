...
import com.waterapp.service.transducer.Transducer3Service;
...
@RestController
@RequestMapping("/api/transducer3")
public class Transducer3Controller {
    @Resource
    private Transducer3Service service;
...
//            String endtime=time+" 23:59:59";
            result.setData(service.findOneDayTransducer3(time));
            result.setMsg("加载成功");
        } catch (Exception ex) {
