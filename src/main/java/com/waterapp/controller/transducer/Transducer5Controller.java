...
import com.waterapp.service.transducer.Transducer5Service;
...
@RestController
@RequestMapping("/api/transducer5")
public class Transducer5Controller {
    @Resource
    private Transducer5Service service;
...
//            String endtime=time+" 23:59:59";
            result.setData(service.findOneDayTransducer5(time));
            result.setMsg("加载成功");
        } catch (Exception ex) {
