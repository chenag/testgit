...
import com.waterapp.service.pump.Pump6Service;
...
@RestController
@RequestMapping("/api/pump6")
public class Pump6Controller {
    @Resource
    private Pump6Service service;
...
//            String endtime=time+" 23:59:59";
            result.setData(service.findOneDayPump6(time));
            result.setMsg("加载成功");
        } catch (Exception ex) {
