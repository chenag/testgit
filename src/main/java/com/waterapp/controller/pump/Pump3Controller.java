...
import com.waterapp.service.pump.Pump3Service;
...
@RestController
@RequestMapping("/api/pump3")
public class Pump3Controller {
    @Resource
    private Pump3Service service;
...
//            String endtime=time+" 23:59:59";
            result.setData(service.findOneDayPump3(time));
            result.setMsg("加载成功");
        } catch (Exception ex) {
