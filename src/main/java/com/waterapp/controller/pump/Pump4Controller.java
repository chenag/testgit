...
import com.waterapp.service.pump.Pump4Service;
...
@RestController
@RequestMapping("/api/pump4")
public class Pump4Controller {
    @Resource
    private Pump4Service service;
...
//            String endtime=time+" 23:59:59";
            result.setData(service.findOneDayPump4(time));
            result.setMsg("加载成功");
        } catch (Exception ex) {
