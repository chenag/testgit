...
/**
 * 密码加盐哈希算法工具类,生成32个字符的密码
 */
public class SecretUtils {
    private static final String PBKDF2_ALGORITHM = "PBKDF2WithHmacSHA1";

    private static final int SALT_BYTE_SIZE = 8;//中间部分长度
    private static final int HASH_BYTE_SIZE = 6;//尾部长度
    private static final int PBKDF2_ITERATIONS = 10;//前缀
