...
import com.waterapp.repository.transducer.Transducer4Repository;
...
@Service
public class Transducer4Service {
    private final Logger log = LoggerFactory.getLogger(getClass());

    @Resource
    Transducer4Repository repository;

    public JSONObject findOneDayTransducer4(String time){
        String[] times={"00:00:00","04:00:00","08:00:00","12:00:00","16:00:00","20:00:00","23:59:59"};
        JSONObject returnJson=new JSONObject();
        for (int i=0;i<times.length-1;i++){
            List<Transducer4> list=new ArrayList<>();
            list=repository.findTransducer4ByDay(time+" "+times[i],time+" "+times[i+1]);
